<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UsesOfProperty.aspx.cs" Inherits="Catalog_UsesOfProperty" MasterPageFile="~/HouseMaster.master" Title="Catalog: Use Of Property" %>

<asp:Content ID="cntHolder" ContentPlaceHolderID="workloadContent" runat="server">
<asp:UpdatePanel ID="updContent" runat="server">
<ContentTemplate>
<h1 class="pageHeader">Use of Property</h1>
<asp:GridView ID="grdUsesOfProperty" FooterStyle-CssClass="catalogTableFooter" ShowFooter="true" OnRowCreated="RowCreated"
             ...
             OnDataBound="grdUsesOfProperty_DataBound" EmptyDataText="This catalog is empty." DataKeyNames="use" DataSourceID="odsGridSource" AutoGenerateColumns="false" runat="server">
<Columns>
...
<asp:FormView ID="frmUsesOfProperty" OnItemInserted="frmUsesOfProperty_ItemInserted" DataSourceID="odsGridSource" DefaultMode="Insert" runat="server">
    <InsertItemTemplate>
...
<asp:ObjectDataSource ID="odsGridSource" ConflictDetection="CompareAllValues" DataObjectTypeName="useOfProperty" TypeName="useOfProperty" SelectMethod="SelectCached" UpdateMethod="Update" InsertMethod="Insert" DeleteMethod="Delete" OldValuesParameterFormatString="oldValue" runat="server" />
