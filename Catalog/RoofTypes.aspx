<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RoofTypes.aspx.cs" Inherits="Catalog_RoofTypes" MasterPageFile="~/HouseMaster.master" Title="Catalog: Roof Type" %>

<asp:Content ID="cntHolder" ContentPlaceHolderID="workloadContent" runat="server">
<asp:UpdatePanel ID="updContent" runat="server">
<ContentTemplate>
<h1 class="pageHeader">Roof Type</h1>
<asp:GridView ID="grdRoofTypes" FooterStyle-CssClass="catalogTableFooter" ShowFooter="true" OnRowCreated="RowCreated"
             ...
             OnDataBound="grdRoofTypes_DataBound" EmptyDataText="This catalog is empty." DataKeyNames="type" DataSourceID="odsGridSource" AutoGenerateColumns="false" runat="server">
<Columns>
...
<asp:FormView ID="frmRoofTypes" OnItemInserted="frmRoofTypes_ItemInserted" DataSourceID="odsGridSource" DefaultMode="Insert" runat="server">
...
<asp:ObjectDataSource ID="odsGridSource" ConflictDetection="CompareAllValues" DataObjectTypeName="roofType" TypeName="roofType" SelectMethod="SelectCached" UpdateMethod="Update" InsertMethod="Insert" DeleteMethod="Delete" OldValuesParameterFormatString="oldValue" runat="server" />
