<%@ Page Language="C#" MasterPageFile="~/HouseMaster.master" AutoEventWireup="true" CodeFile="WindowProtectionSur.aspx.cs" Inherits="Catalog_WindowProtectionSur" Title="Catalog: Window Protection Surcharge" %>

<asp:Content ID="Content1" ContentPlaceHolderID="workloadContent" Runat="Server">
<asp:UpdatePanel ID="updContent" runat="server">
<ContentTemplate>
<h1 class="pageHeader">Window Protection Surcharge</h1>
...
<asp:GridView ID="grdWindowProtection" FooterStyle-CssClass="catalogTableFooter" ShowFooter="true" OnRowCreated="RowCreated"
             ...
             EmptyDataText="This catalog is empty." DataKeyNames="company,windowProtection" DataSourceID="odsGridSource" AutoGenerateColumns="false" runat="server">
    <Columns>
...
<asp:ObjectDataSource ID="odsGridSource" TypeName="WindowProtectionSurcharge" SelectMethod="Select" UpdateMethod="Update" runat="server">
    <SelectParameters>
        <asp:ControlParameter Type="Int32" Name="company" ControlID="ddlCompanies" />
    </SelectParameters>
    <UpdateParameters>
        <asp:Parameter Name="company" Type="Int32" />
        <asp:Parameter Name="windowProtection" Type="Int32" />
