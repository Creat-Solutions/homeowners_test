<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TheftProtection.aspx.cs" Inherits="Catalog_TheftProtection" MasterPageFile="~/HouseMaster.master" Title="Catalog: Theft Protection" %>

<asp:Content ID="cntHolder" ContentPlaceHolderID="workloadContent" runat="server">
<asp:UpdatePanel ID="updContent" runat="server">
<ContentTemplate>
<h1 class="pageHeader">Theft Protection</h1>
<asp:GridView ID="grdTheftProtection" FooterStyle-CssClass="catalogTableFooter" ShowFooter="true" OnRowCreated="RowCreated"
             ...
             OnDataBound="grdTheftProtection_DataBound" EmptyDataText="This catalog is empty." DataKeyNames="id" DataSourceID="odsGridSource" AutoGenerateColumns="false" runat="server">
<Columns>
...
<asp:FormView ID="frmTheftProtection" OnItemInserted="frmTheftProtection_ItemInserted" DataSourceID="odsGridSource" DefaultMode="Insert" runat="server">
...
<asp:ObjectDataSource ID="odsGridSource" ConflictDetection="CompareAllValues" DataObjectTypeName="theftProtection" TypeName="theftProtection" SelectMethod="SelectCached" UpdateMethod="Update" InsertMethod="Insert" DeleteMethod="Delete" OldValuesParameterFormatString="oldValue" runat="server" />
