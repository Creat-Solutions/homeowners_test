<%@ Page Language="C#" MasterPageFile="~/HouseMaster.master" AutoEventWireup="true" CodeFile="TypesOfPropertySur.aspx.cs" Inherits="Catalog_TypesOfPropertySur" Title="Catalog: Type Of Property Surcharge" %>

<asp:Content ID="Content1" ContentPlaceHolderID="workloadContent" Runat="Server">
<asp:UpdatePanel ID="updContent" runat="server">
<ContentTemplate>
<h1 class="pageHeader">Type of Property Surcharge</h1>
...
<asp:GridView ID="grdTypesOfProperty" FooterStyle-CssClass="catalogTableFooter" ShowFooter="true" OnRowCreated="RowCreated"
             ...
             EmptyDataText="This catalog is empty." DataKeyNames="company,typeOfProperty" DataSourceID="odsGridSource" AutoGenerateColumns="false" runat="server">
    <Columns>
...
<asp:ObjectDataSource ID="odsGridSource" TypeName="TypeOfPropertySurcharge" SelectMethod="Select" UpdateMethod="Update" runat="server">
    <SelectParameters>
        <asp:ControlParameter Type="Int32" Name="company" ControlID="ddlCompanies" />
    </SelectParameters>
    <UpdateParameters>
        <asp:Parameter Name="company" Type="Int32" />
        <asp:Parameter Name="typeOfProperty" Type="Int32" />
