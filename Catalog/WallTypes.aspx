<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WallTypes.aspx.cs" Inherits="Catalog_WallTypes" MasterPageFile="~/HouseMaster.master" Title="Catalog: Wall Type" %>

<asp:Content ID="cntHolder" ContentPlaceHolderID="workloadContent" runat="server">
<asp:UpdatePanel ID="updContent" runat="server">
<ContentTemplate>
<h1 class="pageHeader">Wall Type</h1>
<asp:GridView ID="grdWallTypes" FooterStyle-CssClass="catalogTableFooter" ShowFooter="true" OnRowCreated="RowCreated"
             ...
             OnDataBound="grdWallTypes_DataBound" EmptyDataText="This catalog is empty." DataKeyNames="type" DataSourceID="odsGridSource" AutoGenerateColumns="false" runat="server">
<Columns>
...
<asp:FormView ID="frmWallTypes" OnItemInserted="frmWallTypes_ItemInserted" DataSourceID="odsGridSource" DefaultMode="Insert" runat="server">  
    <InsertItemTemplate>
...
<asp:ObjectDataSource ID="odsGridSource" ConflictDetection="CompareAllValues" DataObjectTypeName="wallType" TypeName="wallType" SelectMethod="SelectCached" UpdateMethod="Update" InsertMethod="Insert" DeleteMethod="Delete" OldValuesParameterFormatString="oldValue" runat="server" />
