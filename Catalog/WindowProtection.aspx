<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WindowProtection.aspx.cs" Inherits="Catalog_WindowProtection" MasterPageFile="~/HouseMaster.master" Title="Catalog: Window Protection" %>

<asp:Content ID="cntHolder" ContentPlaceHolderID="workloadContent" runat="server">
<asp:UpdatePanel ID="updContent" runat="server">
<ContentTemplate>
<h1 class="pageHeader">Window Protection</h1>
<asp:GridView ID="grdWindowProtection" FooterStyle-CssClass="catalogTableFooter" ShowFooter="true" OnRowCreated="RowCreated"
             ...
             OnDataBound="grdWindowProtection_DataBound" EmptyDataText="This catalog is empty." DataKeyNames="protection" DataSourceID="odsGridSource" AutoGenerateColumns="false" runat="server">
<Columns>
...
<asp:FormView ID="frmWindowProtection" OnItemInserted="frmWindowProtection_ItemInserted" DataSourceID="odsGridSource" DefaultMode="Insert" runat="server">  
    <InsertItemTemplate>
...
<asp:ObjectDataSource ID="odsGridSource" ConflictDetection="CompareAllValues" DataObjectTypeName="windowProtection" TypeName="windowProtection" SelectMethod="SelectCached" UpdateMethod="Update" InsertMethod="Insert" DeleteMethod="Delete" OldValuesParameterFormatString="oldValue" runat="server" />
