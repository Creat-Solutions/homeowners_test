<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientTypes.aspx.cs" Inherits="Catalog_ClientType" MasterPageFile="~/HouseMaster.master" Title="Catalog: Client Type" %>

<asp:Content ID="cntHolder" ContentPlaceHolderID="workloadContent" runat="server">
<asp:UpdatePanel ID="updContent" runat="server">
<ContentTemplate>
<h1 class="pageHeader">Client Type</h1>
<asp:GridView ID="grdClientTypes" FooterStyle-CssClass="catalogTableFooter" ShowFooter="true" OnRowCreated="RowCreated"
             ...
             OnDataBound="grdClientTypes_DataBound" EmptyDataText="This catalog is empty." DataKeyNames="type" DataSourceID="odsGridSource" AutoGenerateColumns="false" runat="server">
<Columns>
...
<asp:FormView ID="frmClientTypes" OnItemInserted="frmClientTypes_ItemInserted" DataSourceID="odsGridSource" DefaultMode="Insert" runat="server">
...
<asp:ObjectDataSource ID="odsGridSource" ConflictDetection="CompareAllValues" DataObjectTypeName="clientType" TypeName="clientType" SelectMethod="SelectCached" UpdateMethod="Update" InsertMethod="Insert" DeleteMethod="Delete" OldValuesParameterFormatString="oldValue" runat="server" />
