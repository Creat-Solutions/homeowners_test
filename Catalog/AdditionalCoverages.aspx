<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdditionalCoverages.aspx.cs" Inherits="Catalog_AdditionalCoverages" MasterPageFile="~/HouseMaster.master" Title="Catalog: Values and Sublimits" %>

<asp:Content ID="cntHolder" ContentPlaceHolderID="workloadContent" runat="server">
<asp:UpdatePanel ID="updContent" runat="server">
<ContentTemplate>
<h1 class="pageHeader">Additional Coverages</h1>
<asp:GridView ID="grdValuesSublimits" FooterStyle-CssClass="catalogTableFooter" ShowFooter="true" OnRowCreated="RowCreated"
             ...
             EmptyDataText="This catalog is empty." DataKeyNames="id" DataSourceID="odsGridSource" AutoGenerateColumns="false" runat="server">
<Columns>
    ...
    <asp:CheckBoxField DataField="defaultChecked" HeaderText="Default?" />
...
<asp:ObjectDataSource ID="odsGridSource" ConflictDetection="CompareAllValues" 
                      DataObjectTypeName="additionalCoverage" TypeName="additionalCoverage" 
                      SelectMethod="SelectCached" UpdateMethod="Update" 
                      OldValuesParameterFormatString="oldValue" runat="server" />
