<%@ Page Language="C#" MasterPageFile="~/HouseMaster.master" AutoEventWireup="true" CodeFile="ClientTypesSur.aspx.cs" Inherits="Catalog_ClientTypesSur" Title="Catalog: Client Type Surcharge" %>

<asp:Content ID="Content1" ContentPlaceHolderID="workloadContent" Runat="Server">
<asp:UpdatePanel ID="updContent" runat="server">
<ContentTemplate>
<h1 class="pageHeader">Client Type Surcharge</h1>
...
<asp:GridView ID="grdClientTypes" FooterStyle-CssClass="catalogTableFooter" ShowFooter="true" OnRowCreated="RowCreated"
             ...
             EmptyDataText="This catalog is empty." DataKeyNames="company,clientType" DataSourceID="odsGridSource" AutoGenerateColumns="false" runat="server">
    <Columns>
...
<asp:ObjectDataSource ID="odsGridSource" TypeName="ClientTypeSurcharge" SelectMethod="Select" UpdateMethod="Update" runat="server">
    <SelectParameters>
