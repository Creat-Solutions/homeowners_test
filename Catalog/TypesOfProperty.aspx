<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TypesOfProperty.aspx.cs" Inherits="Catalog_TypesOfProperty" MasterPageFile="~/HouseMaster.master" Title="Catalog: Type of Property" %>

<asp:Content ID="cntHolder" ContentPlaceHolderID="workloadContent" runat="server">
<asp:UpdatePanel ID="updContent" runat="server">
<ContentTemplate>
<h1 class="pageHeader">Type of Property</h1>
<asp:GridView ID="grdTypesOfProperty" FooterStyle-CssClass="catalogTableFooter" ShowFooter="true" OnRowCreated="RowCreated"
             ...
             OnDataBound="grdTypesOfProperty_DataBound" EmptyDataText="This catalog is empty." DataKeyNames="type" DataSourceID="odsGridSource" AutoGenerateColumns="false" runat="server">
<Columns>
    ...
    <asp:TemplateField HeaderText="Description">
        ...
        <EditItemTemplate>
            <asp:TextBox ID="txtEditDescription" MaxLength="32" Text='<%# Bind("description") %>' runat="server" />
            <user:LengthValidator ID="lenDescription" Text="(too many characters)" MaxLength="32" Display="Dynamic" ControlToValidate="txtEditDescription" runat="server" />
...
<asp:FormView ID="frmTypesOfProperty" OnItemInserted="frmTypesOfProperty_ItemInserted" DataSourceID="odsGridSource" DefaultMode="Insert" runat="server">
    <InsertItemTemplate>
        <asp:Label ID="lblDescription" AssociatedControlID="txtInsertDescription" Text="Description: " runat="server" />
        <asp:TextBox ID="txtInsertDescription" MaxLength="32" EnableViewState="false" Text='<%# Bind("description") %>' runat="server" />
        <user:LengthValidator ID="lenDescription" Text="(too many characters)" MaxLength="32" Display="Dynamic" ControlToValidate="txtInsertDescription" runat="server" />
...
<asp:ObjectDataSource ID="odsGridSource" ConflictDetection="CompareAllValues" DataObjectTypeName="typeOfProperty" TypeName="typeOfProperty" SelectMethod="SelectCached" UpdateMethod="Update" InsertMethod="Insert" DeleteMethod="Delete" OldValuesParameterFormatString="oldValue" runat="server" />
