<%@ Page Language="C#" MasterPageFile="~/HouseMaster.master" AutoEventWireup="true" CodeFile="ReportQuote.aspx.cs" Inherits="ReportQuote" Title="Quote Reports" %>
...
<script type="text/javascript">
    ...
    function GetExcelReport() {
        ...
        var quote = $get('<%= txtQuote.ClientID %>').value;
        var name = $get('<%= txtName.ClientID %>').value;
        location.href = '/Reports/ReportExcel.ashx?id=' + quote + '&name=' + name + '&agent=' + agent + '&startDate=' + startDate + '&endDate=' + endDate + '&quote=1';
        return false;
    }
    ...
    <table>
    <tr>
        <td class="pageHeader">Quote Reports</td>
    </tr>
    <tr>
        <td>
        <table>
            <tr>
                <td>Broker: </td><td><asp:TextBox ID="txtAgent" runat="server" /><asp:CompareValidator ID="cmpAgent" Display="Dynamic" Text="Invalid value" ControlToValidate="txtAgent" Operator="DataTypeCheck" Type="Integer" runat="server" /></td>
            ...
            <tr>
                <td>Quote Number: </td><td><asp:TextBox ID="txtQuote" runat="server" />
                <asp:CompareValidator Display="Dynamic" Text="Invalid number" ID="cmpQuote" ControlToValidate="txtQuote" Operator="DataTypeCheck" Type="Integer" runat="server" /></td>
