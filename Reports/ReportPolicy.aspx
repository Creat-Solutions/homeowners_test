<%@ Page Language="C#" MasterPageFile="~/HouseMaster.master" AutoEventWireup="true" CodeFile="ReportPolicy.aspx.cs" Inherits="ReportPolicy" Title="Policy Reports" %>
...
<table>
    ...
    <tr>
        ...
        <table>
            ...
            <tr>
                <td>Policy Number: </td><td><asp:TextBox ID="txtPolicy" runat="server" />
                </td>
