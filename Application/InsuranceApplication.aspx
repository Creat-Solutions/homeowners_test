<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InsuranceApplication.aspx.cs" Inherits="InsuranceApplication" MasterPageFile="~/HouseMaster.master" %>
    ...
    <div id="barSteps">
        <table cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>
                    <asp:ImageButton ID="imgStep5" OnClientClick="return removeMouseOut(this);" OnClick="goToStep" CausesValidation="false" EnableViewState="false" ImageUrl="~/images/step5.jpg" runat="server" />
                </td>
                <td>
                    <asp:ImageButton ID="imgStep6" OnClientClick="return removeMouseOut(this);" OnClick="goToStep" CausesValidation="false" EnableViewState="false" ImageUrl="~/images/step6.jpg" runat="server" />
                </td>
                <td>
                    <asp:ImageButton ID="imgStep7" OnClientClick="return removeMouseOut(this);" OnClick="goToStep" CausesValidation="false" EnableViewState="false" ImageUrl="~/images/step7.jpg" runat="server" />
                </td>
                <td>
                    <asp:ImageButton ID="imgStep8" OnClientClick="return removeMouseOut(this);" OnClick="goToStep" CausesValidation="false" EnableViewState="false" ImageUrl="~/images/step8.jpg" runat="server" />
                </td>
            </tr>
        </table>
    </div>
