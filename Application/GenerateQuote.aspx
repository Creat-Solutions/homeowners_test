<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GenerateQuote.aspx.cs" Inherits="GenerateQuote" MasterPageFile="~/HouseMaster.master" %>
...
<div id="insuranceApp">
    <div id="headerApp">
        <span id="lblFormTitle" style="filter: alpha(opacity=100); display: inline-block;">
            <asp:Literal ID="formTitle" runat="server" />
        </span>
        <span style="float:right">
            <asp:ImageButton ID="imgMxFlag" CausesValidation="false" 
             ImageUrl="~/images/MXFlag.gif" runat="server" />
            <asp:ImageButton ID="imgUsFlag" CausesValidation="false" 
             ImageUrl="~/images/USFlag.png" runat="server" />
        </span>
    </div>
    <div id="barSteps">
...
<asp:Button ID="btnSearchExpiring" CausesValidation="false" OnClick="btnSearchExpiring_Click" Text="<%$ Resources:, strSearchExpiring %>" style="position: absolute; right: 60px;" runat="server" />
<asp:Button ID="btnPrevious" CausesValidation="false" OnClick="btnPrevious_click" Text="<%$ Resources:, strPrevious %>" runat="server" />
<asp:Button ID="btnNext" OnClick="btnNext_click" Text="<%$ Resources:, strNext %>" runat="server" />
<asp:Button ID="btnCancel" OnClick="btnCancel_click" style="position: absolute; right: 0;" CausesValidation="false" Text="<%$ Resources:, strCancel %>" runat="server" />
</div>
<br />
<br />
